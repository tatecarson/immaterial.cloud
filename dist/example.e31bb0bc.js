...
},{"buffer":"node_modules/buffer/index.js"}],"../src/Events.js":[function(require,module,exports) {
"use strict";
...
},{}],"../src/Ids.js":[function(require,module,exports) {
"use strict";
...
exports.default = Ids;
},{}],"../src/Granular.js":[function(require,module,exports) {
"use strict";
...
},{"lodash":"../node_modules/lodash/lodash.js","./Events":"../src/Events.js","./Ids":"../src/Ids.js"}],"node_modules/tone/build/Tone.js":[function(require,module,exports) {
var define;
...
async function init() {
  ...
  const audioContext = new _tone.default.Context(); // console.log(toneContext); 

  const granular = new _Granular.default({
    audioContext,
    envelope: {
      attack: 0,
      decay: 0.5
  ...
  const buffer = new _tone.default.Buffer('example.wav', () => console.log(buffer.toArray()));
  console.log(data, buffer.get()); // TODO: get the buffer to go in here
...
init();
},{"../src/Granular":"../src/Granular.js","tone":"node_modules/tone/build/Tone.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
